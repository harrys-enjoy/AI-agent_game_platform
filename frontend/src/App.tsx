...
export default function App() {
  ...
  return <div className={`shell ${uiVariant === "updated" ? "updated-ui" : "legacy-ui"} ${activeChat ? "chat-active" : "section-active"}`} data-active-chat={currentChat}><UpdatedReportNav variant={uiVariant} activeSection={activeSection} onSelect={handleSectionClick} /><TaskQuickActions variant={uiVariant} currentChat={activeChat} onSelect={selectQuickAction} />{activeSection === "Today Briefing" && !activeChat && <ReportPanel kind="briefing" />}{activeSection === "Weekly Report" && !activeChat && <ReportPanel kind="weekly" />}
