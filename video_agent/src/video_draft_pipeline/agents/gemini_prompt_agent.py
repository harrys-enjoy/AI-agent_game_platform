...
def _build_input(scene: Scene, feedback: str | None = None) -> str:
    ...
    text = (
        ...
        "The Subject, Visual style, and Color palette below are a fixed "
        "blueprint shared by every scene in this video — translate them "
        "faithfully into English and keep the description consistent with "
        "how the same character/style would be described in any other scene "
        "of this project. Do not invent a different look for it.\n\n"
