...
class ConversationStore:
    ...
    def append(self, agent_name: str, role: str, content: str, session_id: str | None = None) -> dict[str, str]:
    ...
    def list_messages(self, agent_name: str, session_id: str | None = None) -> list[dict[str, str]]:
        conversation_id, current_session_id = self._conversation(agent_name)
        session_id = session_id or current_session_id
